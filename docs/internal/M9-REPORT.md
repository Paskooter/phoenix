...
**Historical report, superseded by the [2026-09-05 audit](../parity/AUDIT.md).** The old
corpus percentages were reproduced, but whole-server compatibility and completion were not.
Use the [current plan](../parity/PLAN.md) and [verified checklist](../parity/TASKS.md);
