...
Source recovery and these bounded checks do not close N-02 or N-08. After the accepted SettingsClient transport fixes, the complete server smoke comparison retains 440 differences, and grammar compilation, broader factory behavior and native build reproduction remain tracked in the [checklist](TASKS.md).
