...
Root accepted and integrated bounded suspension HTTP/state behavior at d0ac8ce: missing-loop/robot errors, caller lookup and robot/admin checks, source validation/success envelopes, durable suspension timestamps and robot list filtering. Its package tree matches the root-tested 678-unit/strict43 integration. Root executed 87 original-client calls and 21 actual original controller controls. LoopUpdated notification effects, full signature verification, remaining Loop operations and complete A-04 remain open. Root verified a guarded household migration against private source captures and the real robot, with identity and enrollment preservation checks. Personal source data and household statistics remain private; full membership lifecycle parity remains open. Root accepted bounded SetEnrollment, UpdateNickname and UpdatePhoneticName, plus failed membership save isolation. Exact source Node 8 comparison matches 16 operation and 22 validation controls; eight original client controls, 826 unit tests and strict43 pass. Remaining operations, full signature verification, production delivery and new-operation robot acceptance remain open. Root deployed d7934a6 and verified all three profile operations on the installed Node6 client using value-preserving saves. Original native notification, dispatcher, household save and canonical KB readback agree; all household and enrollment preservation checks pass. Clock view/TTS/idle also pass. Other operations and full A-04 remain open. Root accepted GetRobot, FindOwner and ListOwnerRobots with verified public signatures. Original Node8 client completed 22 signed calls through Account/Classic; 837 unit tests and strict 43 pass. Stale-relation 500 code differs while retryable status matches; live robot lookup acceptance and full A-04 remain open. Root accepted shared public Loop signature verification before handler execution. Original Node8 client made 36 signed calls plus 8 anonymous-policy controls; 68 root outcome/state checks, 839 combined unit tests and strict 43 pass. Non-Loop auth, unimplemented handlers and live robot acceptance remain open. Root deployed reviewed shared Loop auth and lookups. Installed Node6 client3.0.105 passed household/owner/robot-list reads and expected owner-credential denial; native notification socket connected, strict TLS retained, and entire account store preserved. No new microphone, screen, profile-mutation or full A-04 acceptance claim. Root accepted bounded record/member/COPPA/auth and Loop list behavior: 58 record client calls, 22 member client calls, six COPPA profiles and 66 list SDK/raw controls. Integrated production source/dependencies match the candidate868-pass/strict43 tree; only test trailing whitespace was normalized. Mail/invitation effects, guardian/agreement review, Mongo behavior, deployment and full A-04 remain open. Root deployed3806425; installed Node6 client3.0.105 passed list/lookup reads, expected robot caller denial and value-preserving UpdateLoopMember. Canonical robot KB observed the saved timestamp; household credentials/profile values preserved. Other mutations, microphone/screen, provider effects and full lifecycle remain open. Root accepted bounded guardian/agreement behavior and repaired provider transport after source review, 30 artifact hashes, 10 original Node8 SDK checks, 871 integration tests and strict43. Synthetic provider only; full Mongo concurrency, live provider/deployment and whole A-04 remain open. Independent photo review requests normal-startup storage/public URL wiring after authenticated upload returned500;27artifact hashes verified. CreateLoop candidate originalSDK10calls passed with4creation/4save events; independent/dependency review remains open. Root accepted bounded ListLoopMembers projection/validation after14source validation rows,2wire population modes,6filter and8visibility controls; combined22originalSDK calls,871unit passes andstrict43. Undefined-versus-absent accountId serializes identically. Mongo ordering, deployment and whole A-04 remain open. Root deployedfb79e6d; original installed Node6client3.0.105 passed8read-only membership/filter/lookup/notification checks withstrictTLS. All6services healthy and complete household accountstore preserved. No new screen/microphone/ring/provider or whole-lifecycle acceptance claim. Root accepted bounded photo update/removal, durable configured storage and public Classic ingress after source review, original Node8 client seven strict-TLS lifecycle checks, Docker container replacement persistence, 876 unit passes with seven skips, and strict43 on unchanged production code. Five observed synthetic test helpers close connections to avoid reproduced idle-pool races; no production timeout/retry changes. Moth deployment and whole A-04 remain open. Root deployed0998f79 with private durable photo directory and public TLS origin. Installed Node6 client passed eight read-only checks; synthetic public photo GET matched exact bytes and returned404 after removal. All six services healthy, native notifications connected and complete household store preserved across guarded rollback/retry. No member photo/profile mutation, microphone/screen/ring or whole-lifecycle acceptance claim. Root accepted invitation mail/event effects, membership lifecycle events, CreateLoop robot-read transport and deferred LoopUpdated scheduling. Combined896unit passes/7skips, strict43,20originalNode8client calls and52root artifact checks pass. Exact source Node8 controls prove population-dependent relative event order. Moth deployment and complete A-04 remain open. Root deployed9672467; six services healthy and eight installedNode6read-only checks pass before/after, including strictTLS and native notification connection. Complete household AccountStore and environment preserved. Live invitation mail remains unconfigured; no microphone/screen/ring/mutation or full lifecycle acceptance claim.
...
Candidate scope: Root accepted invitation mail/event effects, membership lifecycle events, CreateLoop robot-read transport and deferred LoopUpdated scheduling. Combined896unit passes/7skips, strict43,20originalNode8client calls and52root artifact checks pass. Exact source Node8 controls prove population-dependent relative event order. Moth deployment and complete A-04 remain open.

Candidate report: [packages/account/src/loopMembership.js](../../packages/account/src/loopMembership.js).

Lead review: Codex root; [docs/parity/evidence/2026-09-08/invitation-acceptance/review.json](../../docs/parity/evidence/2026-09-08/invitation-acceptance/review.json). Complete task acceptance is still governed by the main checkbox above.
