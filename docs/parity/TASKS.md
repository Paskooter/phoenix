...
Candidate scope: Root accepted bounded ListLoopMembers projection/validation after14source validation rows,2wire population modes,6filter and8visibility controls; combined22originalSDK calls,871unit passes andstrict43. Undefined-versus-absent accountId serializes identically. Mongo ordering, deployment and whole A-04 remain open.

Candidate report: [docs/parity/candidates/A-04-loop-list-members-20260908.md](../../docs/parity/candidates/A-04-loop-list-members-20260908.md).

Lead review: Codex root; [docs/parity/evidence/2026-09-08/loop-list-members/review.json](../../docs/parity/evidence/2026-09-08/loop-list-members/review.json). Complete task acceptance is still governed by the main checkbox above.
