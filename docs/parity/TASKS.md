...
Candidate scope: Root accepted bounded guardian/agreement behavior and repaired provider transport after source review, 30 artifact hashes, 10 original Node8 SDK checks, 871 integration tests and strict43. Synthetic provider only; full Mongo concurrency, live provider/deployment and whole A-04 remain open.

Candidate report: [docs/parity/candidates/A-04-agreements-transport-repair-20260908.md](../../docs/parity/candidates/A-04-agreements-transport-repair-20260908.md).

Lead review: Codex root; [docs/parity/evidence/2026-09-08/loop-agreements/review.json](../../docs/parity/evidence/2026-09-08/loop-agreements/review.json). Complete task acceptance is still governed by the main checkbox above.
