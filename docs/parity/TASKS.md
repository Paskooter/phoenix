...
Candidate scope: Root accepted bounded record/member/COPPA/auth and Loop list behavior: 58 record client calls, 22 member client calls, six COPPA profiles and 66 list SDK/raw controls. Integrated production source/dependencies match the candidate868-pass/strict43 tree; only test trailing whitespace was normalized. Mail/invitation effects, guardian/agreement review, Mongo behavior, deployment and full A-04 remain open.
...
Lead review: Codex root; [docs/parity/evidence/2026-09-08/loop-membership-list/review.json](../../docs/parity/evidence/2026-09-08/loop-membership-list/review.json). Complete task acceptance is still governed by the main checkbox above.
